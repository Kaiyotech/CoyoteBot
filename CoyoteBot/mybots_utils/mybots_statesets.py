...
class TestScore(StateSetter):
    ...
    def reset(self, state_wrapper: StateWrapper):
        ...
        desired_car_pos = [0, 3000, 20]
        desired_rotation = [0, 90 * DEG_TO_RAD, 0]
        car_attack.set_pos(*desired_car_pos)
        car_attack.set_rot(*desired_rotation)
        car_attack.boost = 100

        car_attack.set_lin_vel(0, 1200, 0)
        car_attack.set_ang_vel(0, 0, 0)

        state_wrapper.ball.set_pos(x=0, y=3800, z=0)
...
class GroundAirDribble(StateSetter):
    def reset(self, state_wrapper: StateWrapper):
        ...
        # x_choice = 1  # TODO testing
        # orange_fix = 1  # TODO testing
        # car_attack = state_wrapper.cars[0]  # TODO testing
        # car_defend = state_wrapper.cars[1]  # TODO testing
